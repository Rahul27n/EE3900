...
\begin{align}
\vec{x^T}\myvec{A & \frac{B}{2} \\ \frac{B}{2} & C} + \myvec{D & E}\vec{x} + F=0\label{eq:1}
\end{align}
...
\begin{align}
\vec{x^T}\myvec{1 & 0 \\ 0 & 0} + \myvec{3 & 0}\vec{x} + 2=0
\end{align}
which is equivalent to :
\begin{align}
x^2 + 3x + 2 = 0
\end{align}
Therefore the required quadratic polynomial is given by $y =x^2 + 3x + 2$.\\
\\The zeroes of the polynomial are given by -1 and -2 as shown in the below figure.
\begin{figure}[!ht]
       \centering
